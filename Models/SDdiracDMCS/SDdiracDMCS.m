...
Model`Name = "SDdiracDMCS";
Model`NameLaTeX ="Singlet doublet Dirac dark matter with complex scalars";
...
LagS = -( MS12 conj[S1].S1 + LamS1H conj[S1].S1.conj[H].H  + LamS/2 conj[S1].S1.conj[S1].S1 );
