...
Model`Name = "MajoranaBLSM";
Model`NameLaTeX ="B-L extended Standard Model with 6 Majorana neutrinos";
Model`Authors = "Andres Rivera, based in F.Staub";
Model`Date = "2019-01-24";
...
FermionFields[[6]] = {v, 3, conj[vR],   0, 1,  1,   8/5};
