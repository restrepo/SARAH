...
FermionFields[[6]] = {nl1, 1, nL1,            0, 1,  1};
FermionFields[[7]] = {nr2, 1, nR2,            0, 1,  1};
FermionFields[[8]] = {rd, 1, {vd, ed},   -1/2, 2,  1};
FermionFields[[9]] = {ru, 1, {-eu,vu},    1/2, 2,  1};
FermionFields[[10]] = {vr, 2, conj[vR],      0, 1,  1};
FermionFields[[11]] = {vr3, 1, conj[vR3],      0, 1,  1};

ScalarFields[[1]] = {H, 1, {Hp, H0},      1/2, 2,  1};
ScalarFields[[2]] = {SP, 1, S0,             0, 1,  1};
ScalarFields[[3]] = {S1, 2, ss1,             0, 1,  1};
...
LagS = -( MS12 conj[S1].S1 + LamS1H conj[S1].S1.conj[H].H  + 1/2 LamS conj[S1].S1.conj[S1].S1 );

LagSP = -( 1/2 mP2 SP.SP + LamSPH SP.SP.conj[H].H + 1/2 LamSP SP.SP.SP.SP ); 

Lagint = -( YRA1 ru.l.S1 + YRB1 nl1.vr.conj[S1] + YRB2 nl1.vr3.conj[S1] + YRC nr2.nl1.SP (*+ YNU vr.l.H + YNU vr3.l.H*)  );
