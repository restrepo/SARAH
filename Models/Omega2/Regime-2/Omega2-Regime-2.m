Off[General::spell]
Print["Model file for the Omega loaded"];

ModelName = "Omega2";
ModelNameLaTeX ="Omega2";
...
Fields[[1]] = {{uL,  dL},  3, qL,   1/6, 2,  3};
Fields[[2]] = {conj[dR],  3, dR,  1/3, 1,  -3};  
Fields[[3]] = {conj[uR],  3, uR,  -2/3, 1,  -3};  
Fields[[4]] = {{vL,  eL},  3, lL,  -1/2, 2, 1};
Fields[[5]] = {conj[eR],  3, eR, 1, 1, 1};
Fields[[6]] = {conj[vR],  3, vR,  0, 1, 1};
Fields[[7]] = {{Hd0, Hdm}, 1, Hd, -1/2, 2, 1};
Fields[[8]] = {{Hup, Hu0}, 1, Hu, 1/2, 2, 1};
Fields[[9]] = {deltaR0,  1, deltaR0,  0, 1, 1};
Fields[[10]] = {deltaRbar0,  1, deltaRbar0,  0, 1, 1};
Fields[[11]] = {{{omegaL0r2/Sqrt[2], omegaLp},{omegaLm, - \
omegaL0r2/Sqrt[2]}},  1, omegaL,  0, 3, 1};
Fields[[12]] = {omegaR0,  1, omegaR0,  0, 1, 1};
...
DEFINITION[EWSB][MatterSector]= 
  {  {{phiR, phiRbar, phiOmR}, {hhR2, ZH}},
     ...
     {{fB, FdeltaR0, FdeltaRbar0, FomegaR0}, {L0, ZN}},
     {{FvL, conj[FvR]}, {N0, Znu}},
     {{SdL},{SDLr2,UDL}},
     {{SuL},{SULr2,UUL}},
     {{SdR},{SDRr2,UDR}},
