...
FermionFields[[6]] = {nr1, 1, nR1,            0, 1,  1,-1};
FermionFields[[7]] = {nl1, 1, nL1,            0, 1,  1,-1};
FermionFields[[8]] = {nr2, 1, nR2,            0, 1,  1,-1};
FermionFields[[9]] = {nl2, 1, nL2,            0, 1,  1,-1};
FermionFields[[10]] = {rd, 1, {vd, ed},   -1/2, 2,  1,-1};
FermionFields[[11]] = {ru, 1, {-eu,vu},    1/2, 2,  1,-1};
FermionFields[[12]] = {vr, 3, conj[vR],      0, 1,  1,1};
...
Lagsinglet = - ( Mn1 nr1.nl1 + Mn2 nr2.nl2  );

Lagdoublet =  - ( MDF rd.ru  + YRD1 rd.H.nr2  + YRD2 conj[H].ru.nl2 );
...
Lagint = -( YRA1 ru.l.S1 + YRA2 ru.l.S2 + YRB1 nl1.vr.S1 + YRB2 nl1.vr.S2 + YRC1 nl2.nr1.SP + YRC2 nr2.nl1.SP + YNU vr.l.H );
...
DEFINITION[EWSB][MatterSector]=   
    {{{phiH,phiS},{hh,ZH}},
     ...
     {{{nL1,nL2, vd}, {nR1, nR2, vu}}, {{xVL,XV}, {xVR,XU}}},
     {{ss1,ss2}, {Ssc, VSs}}
    };  
