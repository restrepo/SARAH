...
Model`Name = "SDdiracDMvs";
Model`NameLaTeX ="Singlet doublet Dirac dark matter version simplified";
Model`Authors = "Andres Rivera. Base in SM by F.Staub";
Model`Date = "2018-12-14";
...
LagS = -( MS12 conj[S1].S1 + LamS/2 conj[S1].S1.conj[S1].S1 +
          MS22 conj[S2].S2 + LamS/2 conj[S2].S2.conj[S2].S2 );

LagSP = -( 1/2 mP2 SP.SP + 1/2 LamSP SP.SP.SP.SP ); 

Lagint = -( YRA1 ru.l.S1 + YRA2 ru.l.S2 + YRB1 nl1.vr.conj[S1] + YRB2 nl1.vr.conj[S2] + YRC nr2.nl1.SP );
