...
Model`Name = "SDdiracDMRS";
Model`NameLaTeX ="Singlet doublet Dirac dark matter with real scalars";
...
LagS = -( 1/2 MS12 conj[S1].S1 + LamS1H conj[S1].S1.conj[H].H  + LamS/2 conj[S1].S1.conj[S1].S1 );

LagSP = -( 1/2 mP2 SP.SP + LamSPH SP.SP.conj[H].H + 1/2 LamSP SP.SP.SP.SP  ); 

Lagint = -( YRA1 ru.l.S1 + YRB1 nl1.vr.S1 + YRC nr2.nl1.SP + YNU vr.l.H );
