...
Model`Name = "DFSSDM";
Model`NameLaTeX ="Doublet fermion singlet scalar Dark Matter";
Model`Authors = "Andres Rivera, Federico v.d. Pahlen (based on SM model by F.Staub)";
Model`Date = "2018-11-19";
