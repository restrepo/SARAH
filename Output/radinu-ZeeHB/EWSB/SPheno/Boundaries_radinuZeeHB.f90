...
vev2=mZ2_mZ*CosW2SinW2/(pi*alphamZ) -(2*vv**2) 
vSM=Sqrt(vev2)
MuSM = 0.5_dp*Lambda_SM*vSM**2 
Call OneLoop_Z_W_SM(vSM,g1SM,g2SM,g3SM,Lambda_SM,-YuSM,YdSM,YeSM,kont,dmZ2,           & 
& dmW2,dmW2_0)
...
Subroutine BoundaryBSM(i_run,g_SM,MAh,MAh2,MetI,MetI2,MFd,MFd2,MFe,MFe2,              & 
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHm,MHm2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,            & 
& ZEL,ZUL,UV,ZH,ZP,ZW,ZZ,alphaH,v,vv,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,             & 
...
Complex(dp) :: cplAhhhVZ(2),cplAhHmVWp(3),cplAhAhcVWpVWp,cplAhAhVZVZ,cpletIhhVZ(2),cpletIHmVWp(3),   & 
...
Complex(dp) :: cplcUFdFdAhL(3,3),cplcUFdFdAhR(3,3),cplcUFdFdetIL(3,3),cplcUFdFdetIR(3,3),            & 
...
MFd = sqrt(MFd2) 
MFu = sqrt(MFu2) 
alphaQ = AlphaEw_T(alphaEW_MS,mudim,MVWp,MHm,MFd,MFu,MFe) 
...
MHm2(1)=MVWp2
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
vev2=mZ2_Q*CosW2SinW2/(pi*alphaQ) -(2*vv**2) 
vSM=Sqrt(vev2)
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,v,vv,g1,g2,              & 
& g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,lam9,lam8,lamh,lam10,epsU,Yu,epsD,               & 
& epsE,Yd,Ye,Yh,mu,mH2,mEt2,m12,mh,.False.)
...
Call Pi1LoopVWp(mW2,MHm,MHm2,MAh,MAh2,MetI,MetI2,MFu,MFu2,MFd,MFd2,MFv,               & 
...
& cplcHmcVWpVZ,cplAhAhcVWpVWp,cpletIetIcVWpVWp,cplhhhhcVWpVWp,cplHmcHmcVWpVWp,           & 
& cplcVWpVPVPVWp3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,cplcVWpcVWpVWpVWp2,cplcVWpcVWpVWpVWp3, & 
& cplcVWpcVWpVWpVWp1,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,kont,dmW2_0)
...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2,sinW2_Q,rho,MAh,MetI,MFe,MFv,Mhh,MHm,MVWp,epsE,g2,ZER,             & 
& v,ZEL,vv,UV,Ye,Yh,ZH,ZP,delta)
...
vev2=4._dp*mz2_run/(g1SM**2+g2SM**2) -(2*vv**2) 
vSM=sqrt(vev2) 
End If 
End Do
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,v,vv,g1,g2,              & 
& g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,lam9,lam8,lamh,lam10,epsU,Yu,epsD,               & 
& epsE,Yd,Ye,Yh,mu,mH2,mEt2,m12,mh,.True.)
...
! Full one-loop corrections
Call CouplingsForSMfermions(Yd,ZDL,ZDR,epsD,ZH,g3,g1,g2,TW,epsU,Yu,ZP,ZUL,            & 
& ZUR,Ye,ZEL,ZER,epsE,Yh,UV,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdetIL,cplcUFdFdetIR,       & 
...
& cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuFuetIL,cplcUFuFuetIR,cplcUFuFdcVWpL,cplcUFuFdcVWpR,   & 
...
& cplcUFeFeetIL,cplcUFeFeetIR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,       & 
& cplcUFeFeVZL,cplcUFeFeVZR,cplcUFeFvcHmL,cplcUFeFvcHmR,cplcUFeFvVWpL,cplcUFeFvVWpR)

Call Sigma1LoopFeMZ(p2,MFe,MFe2,MAh,MAh2,MetI,MetI2,Mhh,Mhh2,MVZ,MVZ2,MHm,            & 
...
& cplcUFeFvcHmL,cplcUFeFvcHmR,cplcUFeFvVWpL,cplcUFeFvVWpR,sigR_l,sigL_l,sigSL_l,sigSR_l)

Call Sigma1LoopFdMZ(p2,MFd,MFd2,MAh,MAh2,MetI,MetI2,Mhh,Mhh2,MVZ,MVZ2,MHm,            & 
& MHm2,MFu,MFu2,MVWp,MVWp2,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdetIL,cplcUFdFdetIR,        & 
& cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,cplcUFdFdVGR,cplcUFdFdVPL,cplcUFdFdVPR,         & 
& cplcUFdFdVZL,cplcUFdFdVZR,cplcUFdFucHmL,cplcUFdFucHmR,cplcUFdFuVWpL,cplcUFdFuVWpR,     & 
& sigR_d,sigL_d,sigSL_d,sigSR_d)

Call Sigma1LoopFuMZ(p2,MFu,MFu2,MAh,MAh2,MetI,MetI2,MVWp,MVWp2,MFd,MFd2,              & 
& MHm,MHm2,Mhh,Mhh2,MVZ,MVZ2,cplcUFuFuAhL,cplcUFuFuAhR,cplcUFuFuetIL,cplcUFuFuetIR,      & 
...
Call ParametersToG160(g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,lam9,               & 
& lam8,lamh,lam10,epsU,Yu,epsD,epsE,Yd,Ye,Yh,mu,mH2,mEt2,m12,mh,gMZ)
...
Subroutine Match_and_Run(delta0,MAh,MAh2,MetI,MetI2,MFd,MFd2,MFe,MFe2,MFu,            & 
...
& lam8,lamh,lam10,epsU,Yu,epsD,epsE,Yd,Ye,Yh,mu,mH2,mEt2,m12,mh,mGut,kont,               & 
& WriteComment,niter)
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(160), gB(160)
Real(dp) :: gC(162),  gD(162) 
Real(dp),Intent(out) :: mGUT
Complex(dp) :: Tad1Loop(2), lambda_SM, lambda_MZ 
Real(dp) :: comp(2), tanbQ, vev2 
Complex(dp) :: cplAhAhUhh(2),cplAhetIUhh(2),cplAhUhhhh(2,2),cplAhUhhVZ(2),cpletIetIUhh(2),           & 
...
Real(dp) ::mass_new(19),mass_old(19),diff_m(19)
...
n_tot = n_tot + 2 
mass_old(n_tot:n_tot+2) = MHm
n_tot = n_tot + 3 
mass_old(n_tot:n_tot+0) = MAh
n_tot = n_tot + 1 
mass_old(n_tot:n_tot+0) = MetI
...
If (kont.Ne.0) Then 
  ...
  Call TerminateProgram 
End If 
Call BoundaryBSM(j,g_SM,MAh,MAh2,MetI,MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,               & 
...
& lam8,lamh,lam10,epsU,Yu,epsD,epsE,Yd,Ye,Yh,mu,mH2,mEt2,m12,mh,delta0,gB,kont)
...
mGUT = 1._dp 
Call GToParameters160(gB,g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,lam9,            & 
...
Subroutine FirstGuess(MAh,MAh2,MetI,MetI2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,             & 
...
Real(dp):: gA(160), gB(160), Scale_Save 
...
End Module Boundaries_radinuZeeHB 
