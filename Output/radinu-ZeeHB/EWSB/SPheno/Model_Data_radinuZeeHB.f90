...
Logical, Save :: CalcLoopDecay_etI=.True.
...
Real(dp) :: ZPOS_0(3, 3)
Real(dp) :: ZPOS_p2(3, 3)
Complex(dp) :: UVOS_0(3, 3)
Complex(dp) :: UVOS_p2(3, 3)
...
Complex(dp) :: mH21L 
Complex(dp) :: mH22L 
Real(dp) :: mass_uncertainty_Q(19), mass_uncertainty_Yt(19), g_SM_save(62) 
...
Real(dp) :: gPFu(3,162),gTFu(3),BRFu(3,162),gPFe(3,159),gTFe(3),BRFe(3,159),gPFd(3,162),          & 
...
Real(dp) :: gP1LFu(3,27),gT1LFu(3),BR1LFu(3,27),gP1LFe(3,24),gT1LFe(3),BR1LFe(3,24),              & 
& gP1LFd(3,27),gT1LFd(3),BR1LFd(3,27),gP1LFv(3,24),gT1LFv(3),BR1LFv(3,24),               & 
& gP1LVZ(1,44),gT1LVZ,BR1LVZ(1,44),gP1LVWp(1,29),gT1LVWp,BR1LVWp(1,29),gP1Lhh(2,60),     & 
& gT1Lhh(2),BR1Lhh(2,60),gP1LHm(3,32),gT1LHm(3),BR1LHm(3,32),gP1LetI(1,56),              & 
& gT1LetI,BR1LetI(1,56)
...
Real(dp) :: g1_saveEP 
Real(dp) :: g2_saveEP 
Complex(dp) :: epsU_saveEP(3,3) 
Complex(dp) :: Yu_saveEP(3,3) 
Complex(dp) :: epsD_saveEP(3,3) 
Complex(dp) :: epsE_saveEP(3,3) 
Complex(dp) :: Yd_saveEP(3,3) 
Complex(dp) :: Ye_saveEP(3,3) 
Complex(dp) :: Yh_saveEP(3,3) 
...
Real(dp) :: vvSUSY 
! For HiggsBounds 
Real(dp) :: BR_HpHW(3,2)  = 0._dp
Real(dp) :: BR_HpAW(3,1) = 0._dp
Real(dp) :: BR_HpTB(3) = 0._dp 
Real(dp) :: BR_HpWZ(3) = 0._dp
Real(dp) :: BR_tHb(3) = 0._dp
Real(dp) :: BR_Hcs(3)= 0._dp 
Real(dp) :: BR_Hcb(3)=0._dp 
Real(dp) :: BR_Htaunu(3)=0._dp 
...
Real(dp) :: BRAAZ(1,1)  = 0._dp 
 Real(dp) :: BRAHpW(2,3)=0._dp
Real(dp) :: BRHhpW(1,3)  = 0._dp 
...
Subroutine SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,v,vv,              & 
& g1,g2,g3,lam1,lam2,lam4,lam3,lam7,lam5,lam6,lam9,lam8,lamh,lam10,epsU,Yu,              & 
& epsD,epsE,Yd,Ye,Yh,mu,mH2,mEt2,m12,mh,MZsuffix)
