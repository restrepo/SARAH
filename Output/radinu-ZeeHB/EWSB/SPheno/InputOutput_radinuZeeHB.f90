...
Case(1004) 
  If (wert.ne.1) CalcLoopDecay_Fv= .False. 
Case(1005) 
  If (wert.ne.1) CalcLoopDecay_hh= .False. 
Case(1006) 
  If (wert.ne.1) CalcLoopDecay_Hm= .False. 
Case(1007) 
  If (wert.ne.1) CalcLoopDecay_etI= .False. 
Case(1101) 
...
If ((MaxVal(Abs(AImag(Yh))).gt.0._dp).OR.(OutputForMG)) Then 
...
If ((MaxVal(Abs(AImag(YhGUT))).gt.0._dp).OR.(OutputForMG)) Then 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 ...
 Write(io_L,102) INT(Abs(900037)), Sqrt(mass_uncertainty_Q(5)**2+mass_uncertainty_Yt(5)**2),"# MHm(3) " 
 Write(io_L,102) INT(Abs(36)), Sqrt(mass_uncertainty_Q(7)**2+mass_uncertainty_Yt(7)**2),"# MetI(1) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 ...
 Write(io_L,102) INT(Abs(900037)), mass_uncertainty_Q(5),"# MHm(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Q(7),"# MetI(1) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 ...
 Write(io_L,102) INT(Abs(900037)), mass_uncertainty_Yt(5),"# MHm(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Yt(7),"# MetI(1) " 
End if
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,28:162)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,28:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
If ((gTVWp.gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2= gt1, 3
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2= gt1, 3
...
icount = icount +1 
  End Do 
End if 
If ((gTHm(3).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRHm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHm(3))//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
If ((gTetI.gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetI 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 3
  Do gt2= gt1, 3
...
CurrentPDG2(2) = PDGFv(gt2) 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
If (BRetI(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGVG 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleVG)//" "//Trim(NameParticleVG)//" "//")"
End if 
icount = icount +1 
If (BRetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVP 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleVP)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZ 
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
If (BRetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGVWp 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleVWp)//"^* "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
If (BRetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGVZ 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleVZ)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
End if 
...
If(gT1LFv(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGFv(1)),gT1LFv(1),Trim(NameParticleFv(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=2, 3
If (BR1LFv(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BR1LFv(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleHm(gt2))//" "//")"
Write(io_L,201) BR1LFv(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHm(gt2))//"^* "//")"
End if 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BR1LFv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LFv(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGFv(2)),gT1LFv(2),Trim(NameParticleFv(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=2, 3
If (BR1LFv(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BR1LFv(2,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleHm(gt2))//" "//")"
Write(io_L,201) BR1LFv(2,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHm(gt2))//"^* "//")"
End if 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BR1LFv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LFv(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGFv(3)),gT1LFv(3),Trim(NameParticleFv(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=2, 3
If (BR1LFv(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGHm(gt2) 
Write(io_L,201) BR1LFv(3,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleHm(gt2))//" "//")"
Write(io_L,201) BR1LFv(3,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleHm(gt2))//"^* "//")"
End if 
...
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BR1LFv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFv(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LVZ.gt.MinWidth) Then 
Write(io_L,210) INT(PDGVZ),gT1LVZ,Trim(NameParticleVZ) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 2
If (BR1LVZ(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGhh(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BR1LVZ(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
...
CurrentPDG2(1) = PDGHm(gt1) 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BR1LVZ(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BR1LVZ(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleVZ)//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
...
If(gT1LVWp.gt.MinWidth) Then 
Write(io_L,210) INT(PDGVWp),gT1LVWp,Trim(NameParticleVWp) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 3
If (BR1LVWp(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGHm(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BR1LVWp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVWp)//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LHm(3).gt.MinWidth) Then 
Write(io_L,210) INT(PDGHm(3)),gT1LHm(3),Trim(NameParticleHm(3)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 2, 3
If (BR1LHm(3,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGHm(gt1) 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BR1LHm(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHm(3))//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LetI.gt.MinWidth) Then 
Write(io_L,210) INT(PDGetI),gT1LetI,Trim(NameParticleetI) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
If (BR1LetI(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGetI 
CurrentPDG2(2) = PDGetI 
Write(io_L,201) BR1LetI(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleetI)//" "//Trim(NameParticleetI)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
...
CurrentPDG2(1) = PDGHm(gt1) 
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BR1LetI(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleHm(gt1))//" "//Trim(NameParticleVWp)//" "//")"
Write(io_L,201) BR1LetI(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleetI)//" -> "//Trim(NameParticleHm(gt1))//"^* "//Trim(NameParticleVWp)//"^* "//")"
End if 
...
Write(91,"(3e16.8)",advance="No") BR_Hcs(3)/gTHm(3) 
Write(91,"(3e16.8)",advance="No") BR_Hcb(3)/gTHm(3) 
Write(91,"(3e16.8)",advance="No") BR_Htaunu(3)/gTHm(3) 
...
Write(91,"(3e16.8)",advance="No") BR_Hcb(3)/gTHm(3) 
Write(91,"(3e16.8)",advance="No") BR_Htaunu(3)/gTHm(3) 
Write(91,"(3e16.8)",advance="No") BR_HpTB(3)/gTHm(3) 
Write(91,"(3e16.8)",advance="No") BR_HpWZ(3)/gTHm(3) 
Write(91,"(3e16.8)",advance="No")BR_HpHW(2,1)/gTHm(2) 
Write(91,"(3e16.8)",advance="No")BR_HpHW(2,2)/gTHm(2) 
Write(91,"(3e16.8)",advance="No")BR_HpHW(3,1)/gTHm(3) 
Write(91,"(3e16.8)",advance="No")BR_HpHW(3,2)/gTHm(3) 
Write(89,"(I1)",advance="No") 1 
